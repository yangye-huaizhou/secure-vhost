#!/bin/bash
export RTE_SDK=/home/yangye/secure-vhost/dpdk-eal-master
export LD_LIBRARY_PATH=/home/yangye/secure-vhost/dpdk-eal-master/x86_64-native-linuxapp-gcc/lib/
...
ovs-vsctl --no-wait set Open_vSwitch . other_config:dpdk-extra="--base-virtaddr 500000000000 --file-prefix=spdk1"
...
ovs-vsctl --no-wait set Open_vSwitch . other_config:dpdk-socket-mem="2048,1"
ovs-vsctl --no-wait set Open_vSwitch . other_config:pmd-cpu-mask=0x400
