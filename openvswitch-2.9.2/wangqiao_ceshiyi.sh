...
ovs-vsctl add-port br0 dpdk-p0 -- set Interface dpdk-p0 type=dpdk options:dpdk-devargs=0000:89:00.0
ovs-vsctl add-port br0 dpdk-p1 -- set Interface dpdk-p1 type=dpdk options:dpdk-devargs=0000:89:00.1
...
ovs-ofctl add-flow br0 "in_port=3,dl_src=00:10:94:00:00:02,actions=output:2"
