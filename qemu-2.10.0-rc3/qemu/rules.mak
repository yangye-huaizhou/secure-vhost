...
LINK_VIRTIO = $(call quiet-command, $(LINKPROG) $(QEMU_CFLAGS) $(CFLAGS) $(LDFLAGS) -o $@ \
       $(call process-archive-undefs, $1) \
       $(version-obj-y) x86_64-softmmu/hw/virtio/vhost.o $(call extract-libs,$1) $(LIBS),"LINK","$(TARGET_DIR)$@")
